...
export default function ExperienceCard({ exp, selected }: ExperienceCardProps) {
  ...
  return (
    <div className={`bg-slate-400/10 hover:bg-slate-400/20 rounded border border-gray-100/10 hover:border-gray-100/20 p-3 hover:scale-105 transition-transform duration-300 cursor-pointer ${selected && "bg-black/40 hover:bg-black/50"}`}>
      ...
      <p className="text-xs text-gray-400 flex items-center gap-2 mt-2 w-full">
